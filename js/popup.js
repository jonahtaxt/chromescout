    ...
    self.silenceAlarm = function (e) {
      chrome.runtime.sendMessage({ silenceAlarm: true }, function (response) {
        if (response.alarmSilenced) {
          self.silenceAlarmButton.addClass('alarmSilenced');
          self.silenceAlarmButton.attr('disabled', 'disabled');
        }
      });
    };
      ...
      self.initialize = function () {
        ...
        function (items) {
          ...
          if (self.nsVars !== null) {
            ...
            self.silenceAlarmButton.click(self.silenceAlarm);
        ...
        chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
          if(request.fifteenMinutesComplete) {
              self.silenceAlarmButton.removeClass('alarmSilenced');
            self.silenceAlarmButton.removeAttr('disabled');
          }
        });
      };
